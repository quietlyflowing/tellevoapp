...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $user_data = [
            ['user_id' => 1, 'nombre' => 'Dummy User', 'telefono' => '912345678', 'direccion_hogar' => 'Santa Cena 4552, Maipú', 'coord_hogar' => json_encode(['coord_x' => -33.4822934, 'coord_y' => -70.7445205]), 'direccion_duoc' => 'Esquina Blanca 501, Maipú', 'coord_duoc' => json_encode(['coord_x' => -33.5112206, 'coord_y' => -70.7575535]),  'created_at' => \Carbon\Carbon::now(), 'updated_at' => \Carbon\Carbon::now()],
            ['user_id' => 2, 'nombre' => 'Test User', 'telefono' => '913248667', 'direción_hogar' => 'Picaflor 503, Maipú','coord_hogar' => json_encode(['coord_x' => -33.4711851, 'coord_y' => -70.7471551]),'direccion_duoc' => 'Esquina Blanca 501, Maipú', 'coord_duoc' => json_encode(['coord_x' => -33.51190, 'coord_y' => -70.75276]),'created_at' => \Carbon\Carbon::now(), 'updated_at' => \Carbon\Carbon::now()]
        ];
        ...
        $history = [
            ['user_id' => 1, 'from_coord' => json_encode(['address'=> 'Las Palomas de San José 421', 'coord_x' => -33.47623, 'coord_y' => -70.74753]), 'to_coord' => json_encode(['address'=> 'Esquina Blanca 501', 'coord_x' => -33.51190, 'coord_y' => -70.75276]), 'payment_type' => 1, 'total_payment' => 8500, 'transport_user' => 'Test User', 'created_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago'),],
            ['user_id' => 1, 'from_coord' => json_encode(['address'=> 'Esquina Blanca 501', 'coord_x' => -33.51190, 'coord_y' => -70.75276]), 'to_coord' => json_encode(['address'=> 'Las Palomas de San José 421', 'coord_x' => -33.47623, 'coord_y' => -70.74753]), 'payment_type' => 1, 'total_payment' => 8500, 'transport_user' => 'Test User','created_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago')],
            ['user_id' => 2, 'from_coord' => json_encode(['address'=> 'Las Palomas de San José 421', 'coord_x' => -33.47623, 'coord_y' => -70.74753]), 'to_coord' => json_encode(['address'=> 'Esquina Blanca 501', 'coord_x' => -33.51190, 'coord_y' => -70.75276]), 'payment_type' => 1, 'total_payment' => 8500, 'transport_user' => 'Dummy User','created_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago'),],
            ['user_id' => 2, 'from_coord' => json_encode(['address'=> 'Esquina Blanca 501', 'coord_x' => -33.51190, 'coord_y' => -70.75276]), 'to_coord' => json_encode(['address'=> 'Las Palomas de San José 421', 'coord_x' => -33.47623, 'coord_y' => -70.74753]), 'payment_type' => 1, 'total_payment' => 8500,'transport_user' => 'Dummy User','created_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago')],
