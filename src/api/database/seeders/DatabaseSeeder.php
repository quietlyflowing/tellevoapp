...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $user_data = [
            ...
            ['user_id' => 1, 'nombre' => 'Dummy User', 'telefono' => '912345678', 'direccion_hogar' => 'Santa Cena 4552, Maipú', 'cord_hogar' => json_encode(['cord_x' => -33.4822934, 'cord_y' => -70.7445205]), 'direccion_duoc' => 'Esquina Blanca 501, Maipú', 'cord_duoc' => json_encode(['cord_x' => -33.5112206, 'cord_y' => -70.7575535]),  'created_at' => \Carbon\Carbon::now(), 'updated_at' => \Carbon\Carbon::now()],
            ['user_id' => 2, 'nombre' => 'Test User', 'telefono' => '913248667', 'direción_hogar' => 'Picaflor 503, Maipú','cord_hogar' => json_encode(['cord_x' => -33.4711851, 'cord_y' => -70.7471551]),'direccion_duoc' => 'Esquina Blanca 501, Maipú', 'cord_duoc' => json_encode(['cord_x' => -33.51190, 'cord_y' => -70.75276]),'created_at' => \Carbon\Carbon::now(), 'updated_at' => \Carbon\Carbon::now()]
        ];
