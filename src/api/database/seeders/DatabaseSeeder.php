...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $history = [
            ['user_id' => 1, 'from_coord' => json_encode(['cord_x' => -33.47623, 'cord_y' => -70.74753]), 'to_coord' => json_encode(['address'=> 'Esquina Blanca 501', 'cord_x' => -33.51190, 'cord_y' => -70.75276]), 'payment' => 1, 'created_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago'),],
            ['user_id' => 1, 'from_coord' => json_encode(['cord_x' => -33.51190, 'cord_y' => -70.75276]), 'to_coord' => json_encode(['address'=> 'Las Palomas de San José 421', 'cord_x' => -33.47623, 'cord_y' => -70.74753]), 'payment' => 1, 'created_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago')],
            ['user_id' => 2, 'from_coord' => json_encode(['cord_x' => -33.47623, 'cord_y' => -70.74753]), 'to_coord' => json_encode(['address'=> 'Esquina Blanca 501', 'cord_x' => -33.51190, 'cord_y' => -70.75276]), 'payment' => 1, 'created_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 10, 30, 50, 'America/Santiago')],
            ['user_id' => 2, 'from_coord' => json_encode(['cord_x' => -33.51190, 'cord_y' => -70.75276]), 'to_coord' => json_encode(['address'=> 'Las Palomas de San José 421','cord_x' => -33.47623, 'cord_y' => -70.74753]), 'payment' => 1, 'created_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago'), 'updated_at' => \Carbon\Carbon::create(2023, 10, 10, 18, 23, 34, 'America/Santiago')],
        ];
